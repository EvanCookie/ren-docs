...
![](https://cdn.jsdelivr.net/gh/EvanCookie/pictureBed@master/other/javaScript_module/module1-2.jpg)
...
1. 每个模块内部的：`this`、 `exports`、 `modules.exports` 在初始时，都指向 **同一个** 空对象，该空对象就是当前模块导出的数据，如下图：![img](https://cdn.jsdelivr.net/gh/EvanCookie/pictureBed@master/other/javaScript_module/CJS.png)
...
第一步：准备文件结构：
![img](https://cdn.jsdelivr.net/gh/EvanCookie/pictureBed@master/other/javaScript_module/AMD.png)
...
第一步：准备文件结构
![img](https://cdn.jsdelivr.net/gh/EvanCookie/pictureBed@master/other/javaScript_module/CMD.png)
::: info
